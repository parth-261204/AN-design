...
const ANDesignsPage = () => {
  ...
  return (
    <div className="font-serif bg-white text-gray-900 min-h-screen" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
      ...
      >
        <nav
          className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between flex-wrap gap-4 px-8 py-4 border-b transition-all duration-300"
          style={{
            background: isNavbarVisible ? "rgba(0,0,0,0.35)" : "transparent",
            backdropFilter: isNavbarVisible ? "blur(8px)" : "none",
            borderColor: isNavbarVisible ? "rgba(255,255,255,0.2)" : "transparent",
          }}
        >
